...
#define PCAP_HANDLER_CREATE 8
#define PCAP_HANDLER_SET_SNAPLEN 9
#define PCAP_HANDLER_SET_PROMISC 10
#define PCAP_HANDLER_SET_TIMEOUT 11
#define PCAP_HANDLER_ACTIVATE 12

#define PCAP_COMPILE 13
#define PCAP_SET_FILTER 14

#define PCAP_SEND_ARP_REQUEST 15
#define PCAP_SEND_SPOOFED_ARP_RESPONSE 16
#define PCAP_SEND_UNSPOOFED_ARP_RESPONSE 17

#define REGISTERWIMONITOR 18
